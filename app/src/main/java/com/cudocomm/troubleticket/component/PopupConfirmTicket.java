...
public class PopupConfirmTicket extends DialogFragment {
...
//    descAlert.setText(argMessage);
  ...
  public static PopupConfirmTicket newInstance(String argTitle, String argDone, String argClose) {
    PopupConfirmTicket f = new PopupConfirmTicket();
