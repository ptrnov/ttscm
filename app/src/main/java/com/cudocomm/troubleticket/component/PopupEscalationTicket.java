...
public class PopupEscalationTicket extends DialogFragment {
...
//    argMessage = getArguments().getString(Constants.ARGS_DESC);
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    rootView = inflater.inflate(R.layout.popup_escalation_ticket, container, false);
    initUI();
    initData();
    return rootView;
  }
...
//    descAlert.setText(argMessage);
  ...
  public static PopupEscalationTicket newInstance(String argTitle, String argDone, String argClose) {
    PopupEscalationTicket f = new PopupEscalationTicket();
...
//    args.putString(Constants.ARGS_DESC, argMessage);
  ...
  public EditText getActionET() {
    return actionET;
  }

  public void setActionET(EditText actionET) {
    this.actionET = actionET;
  }

  public EditText getRequireET() {
    return requireET;
  }

  public void setRequireET(EditText requireET) {
    this.requireET = requireET;
  }
}
