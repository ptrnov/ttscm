...
public class PopupGuidanceTicket extends DialogFragment {
...
//    argMessage = getArguments().getString(Constants.ARGS_DESC);
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    rootView = inflater.inflate(R.layout.popup_guidance_ticket, container, false);
    initUI();
    initData();
    return rootView;
  }
...
//    descAlert.setText(argMessage);
  ...
  public static PopupGuidanceTicket newInstance(String argTitle, String argDone, String argClose) {
    PopupGuidanceTicket f = new PopupGuidanceTicket();
