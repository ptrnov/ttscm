...
public class PopupReAssignmentTicket extends DialogFragment implements DatePickerDialog.OnDateSetListener {
...
//  private String argMessage;
  ...
  private MaterialSpinner reassignToSpinner;
...
//  private EditText requireET;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    rootView = inflater.inflate(R.layout.popup_reassignment_ticket, container, false);
    initUI();
    initData();
    return rootView;
  }
  ...
  private void initUI() {
    ...
    reassignToSpinner = (MaterialSpinner) rootView.findViewById(R.id.reassignToSpinner);
...
//              now.setTimeInMillis();setMinDate(newDate.getTime());

              DatePickerDialog dpd = DatePickerDialog.newInstance(
                      PopupReAssignmentTicket.this,
...
//                        selectedEngineer.setUserName(hSpinner.spinnerValueTV.getText().toString());
  ...
  public static PopupReAssignmentTicket newInstance(String argTitle, String argDone, String argClose, List<UserModel> engineers) {
    PopupReAssignmentTicket f = new PopupReAssignmentTicket();
...
//    args.putString(Constants.ARGS_DESC, argMessage);
  ...
  public MaterialSpinner getReassignToSpinner() {
    return reassignToSpinner;
  }
