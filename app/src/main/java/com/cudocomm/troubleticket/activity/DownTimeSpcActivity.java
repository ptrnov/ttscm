...
public class DownTimeSpcActivity extends AppCompatActivity {
...
//    private SeverityAdapter2 severityAdapter2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_down_time_spc);
...
//        MaterialSpinner suspect4Spinner = (MaterialSpinner) findViewById(R.id.suspect4Spinner);
        ...
        submitNewTicket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if(stationSpinner.getSelectedItemPosition() == 0) {
                    stationSpinner.getSelectedView().requestFocus();
                    stationSpinner.setError(getResources().getString(R.string.error_station_empty));
