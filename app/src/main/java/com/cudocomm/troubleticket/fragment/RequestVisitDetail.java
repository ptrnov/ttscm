...
public class RequestVisitDetail extends BaseFragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_request_visit_detail, container, false);
...
//        add ticket position
        ...
        rejectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                popConfirm = new CustomPopConfirm().newInstance("Reject Request", "Are you sure reject request visit onsite?", "Yes", "No");
        ...
        approveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                popupApprovalRequestVisitTicket.show(getActivity().getSupportFragmentManager(), null);
            }
        });
    }
    ...
    class SubmitApprovalRequestVisitTask extends AsyncTask<Void, Void, Void> {
...
//                        .add(Constants.PARAM_ID, selectedAssignment.getAssignmentId())
                        .add(Constants.PARAM_ID, selectedAssignment.getTicket().getTicketId())
    ...
    class RejectRequestVisitTask extends AsyncTask<Void, Void, Void> {
