...
public class RequestVisit extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_request_visit, container, false);
        ...
        protected Void doInBackground(Void... params) {
            try {
                result = ApiClient.post(
                        CommonsUtil.getAbsoluteUrl(Constants.URL_GET_REQUEST_VISIT),
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                if(object.get(Constants.RESPONSE_STATUS).equals(Constants.RESPONSE_SUCCESS)) {
                    Log.d("Object111",String.valueOf(object.getString("new_tickets")));
                    ...
                    if(assignments.size() > 0) {
                        assignmentAdapter = new AssignmentAdapter(assignments, new AssignmentAdapter.OnItemClickListener() {
                            ...
                            public void onItemClick(Assignment assignment) {
                                Fragment f = new RequestVisitDetail();
                                String page = Constants.REQUEST_VISIT_DETAIL_PAGE;
                                Boolean flag = Boolean.FALSE;
                                Bundle args = new Bundle();
                                args.putString(Constants.PARAM_SECTION, Constants.REQUEST_VISIT_PAGE);
