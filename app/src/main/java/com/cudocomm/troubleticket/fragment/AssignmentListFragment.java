...
public class AssignmentListFragment extends BaseFragment {
    ...
    public static AssignmentListFragment newInstance(String val) {
    ...
    public void loadTickets() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, CommonsUtil.getAbsoluteUrl(Constants.URL_GET_ASSIGNMENT_TICKET),
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jObj.getString("status").equalsIgnoreCase("success")) {
                                ...
                                assignments = gson.fromJson(jObj.getString("new_tickets"), type);
                                ...
                                if(assignments.size() > 0) {
                                    if(assignmentAdapter == null) {
                                        ...
                                        ticketListRV.setAdapter(assignmentAdapter);
                                    } else {
                                        assignmentAdapter.swap(assignments);
                                    }
...
//                                                getActivity().startActivityForResult(intent, Constants.REQUEST_CODE);
                                                getActivity().startActivityForResult(intent, Constants.REQUEST_VIEW_ASSIGNMENT);
