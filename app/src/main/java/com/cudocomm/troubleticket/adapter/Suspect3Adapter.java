...
public class Suspect3Adapter extends BaseAdapter {

    private Context context;
    private List<Suspect3Model> iSuspects;
    private Suspect3Model selectedISuspect;

    public Suspect3Adapter(Context context, List<Suspect3Model> iSuspects) {
