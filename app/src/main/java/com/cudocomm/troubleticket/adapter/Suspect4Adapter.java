...
public class Suspect4Adapter extends BaseAdapter {

    private Context context;
    private List<Suspect4Model> iSuspects;
    private Suspect4Model selectedISuspect;

    public Suspect4Adapter(Context context, List<Suspect4Model> iSuspects) {
