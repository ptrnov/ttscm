...
public class Suspect2Adapter extends BaseAdapter {

    private Context context;
    private List<Suspect2Model> iSuspects;
    private Suspect2Model selectedISuspect;

    public Suspect2Adapter(Context context, List<Suspect2Model> iSuspects) {
